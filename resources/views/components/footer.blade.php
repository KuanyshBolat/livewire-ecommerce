<footer class="main">
            ...
            <div class="row">
                    ...
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                        ...
                        <ul class="contact-infor">
                            <li><img src="/assets/imgs/theme/icons/icon-location.svg"
                                     alt=""/><strong>Adress: </strong>
                                <span> Kazakhstan
                                    <br> 050000 Almaty, Manasa 34A
                                    <br>  </span></li>
                            <li><img src="/assets/imgs/theme/icons/icon-contact.svg"
                                     alt=""/><strong>Telefono:</strong><span><a href="tel:87273200000">  8 (727) 320-00-00</a> </span>
                            </li>
                            <li><img src="/assets/imgs/theme/icons/icon-email-2.svg"
                                     alt=""/><strong>Email:</strong><a href="mailto:reseption@iitu.edu.kz"> reseption@iitu.edu.kz</a></li>
                ...
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                    ...
                    <ul class="footer-list mb-sm-5 mb-md-0">
                        {{--                        <li><a href="{{route('customerLogin',app()->getLocale())}}">Login</a></li>--}}
                        <li><a href="{{route('cart', app()->getLocale())}}">Cart</a></li>
                        <li><a href="{{route('wishlist', app()->getLocale())}}">Fovorite items</a></li>
                    </ul>
                </div>
    ...
    <div class="container pb-30 wow animate__animated animate__fadeInUp row align-items-center" data-wow-delay="0">
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <p class="font-sm mb-0">© {{ date('Y') }} - Livewire E-commerce <br>Designed by <a
                            href="https://www.instagram.com/2_kuanysh_2/" target="_blank"><strong class="text-brand">Bolat Kuanysh</strong></a></p>
            </div>
